...
@pytest.fixture
def mux(
    bin_path: pathlib.PurePath, request: pytest.FixtureRequest
) -> subprocess.Popen[bytes]:
    return subprocess.Popen([bin_path] + request.param, stdout=subprocess.PIPE)


@pytest.mark.parametrize(
    "params", [["--help"], ["-h"], ["-h", "-l", "8000"], ["-h", "127.0.0.1", "8000"]]
)
...
@pytest.mark.parametrize("params", [["foobar"], [""]])
